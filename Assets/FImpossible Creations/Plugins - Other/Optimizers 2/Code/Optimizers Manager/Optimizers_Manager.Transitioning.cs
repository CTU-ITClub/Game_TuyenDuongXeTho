...
namespace FIMSpace.FOptimizing
{
    public partial class OptimizersManager
    {
        ...
        {
            // Sửa lỗi ở đây: Dùng GetHashCode() thay vì GetEntityId() để tránh lỗi ép kiểu (cast) ngầm định EntityId sang int
            int optimizerId = optimizer.GetHashCode(); // Id code for quicker search in list
        ...
        {
            // Sửa lỗi ở đây: Dùng GetHashCode() thay vì GetEntityId()
            int optimizerId = optimizer.GetHashCode(); // Hash code for quicker search in list
