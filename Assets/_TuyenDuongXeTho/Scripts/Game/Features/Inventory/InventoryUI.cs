...
public class InventoryUI : MonoBehaviour
{
    ...
    private void Start()
    {
        //Check PhotonView.IsMine trước khi build UI, tránh trường hợp client khác build UI của mình
        if (inventorySystem == null || !inventorySystem.photonView.IsMine) return;
