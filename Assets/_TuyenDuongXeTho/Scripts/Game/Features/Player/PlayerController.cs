...
namespace Game.Features.Player
{
    ...
    _groundLayer
        ...
        public void MountVehicle(IVehicleable slot)
        {
            ...
            //báo cho slot biết có người ngồi lên xe 
            slot.OnInteractEnter(this);

            //setup player trên slot
            Transform mountPoint = slot.GetMountPoint();
        ...
        public void DismountVehicle()
        {
            ...
            transform.position += transform.right * 1.5f + Vector3.up * 0.5f;
