...
{
    public class VehicleVisuals : MonoBehaviourPun, IPunObservable
    {
        ...
        private void UpdateSteer()
        {
            ...
            {
                target = _steerWheel != null
                    ? _steerWheel.steerAngle
                    : 0f;
            }
            else
            {
                target = _networkSteer;
            }
        ...
        public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info)
        {
            ...
            {
                _networkSteer = (float)stream.ReceiveNext();
            }
        }
    }
}